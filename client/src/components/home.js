...
function Home({ name, ...props }) {
  ...
  useEffect(() => {
    const fetchMemberActivites = async () => {
      // fetch all actvities registration info where google Id is equall to googleId
      try {
    ...
    <div>
      ...
      >
        ...
        <Card.Body>
          ...
          <Card.Text>
            Make a payment for MHMA membership fees, zakat, masjid donation, or
            sadaqah.
          </Card.Text>
          <Button
            onClick={goToPayment}
      ...
      >
        ...
        <Card.Body>
          ...
          <Card.Text>
            Volunteer for MHMA events, such as Sunday School setup/cleanup or
      ...
      >
        ...
        <Card.Body>
          ...
          <Card.Text>
            Sign Up for MHMA Activities, such as Youth Soccer, Tafseer-E-Quran,
