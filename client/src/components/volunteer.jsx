...
const Volunteer = (props) => {
    ...
    const [events] = useState({
        ...
        event3: "Coding Tutor",
        event4: "Soccer Referee",
        event5: "Sunday School Setup",
        event6: "Sunday School Cleanup",
    });
    ...
    if (showEvent) {
        return <VolunteerSignup event={showEvent} />
    }
                ...
                <Container>
                    ...
                    <Card style={{ position: 'absolute', left: '17%', top: '25%', height: '18rem', width: '24rem' }}>
                        <Card.Body>
                            ...
                            <Button style={{ position: 'absolute', left: '0%', top: '87%' }}
                                variant="dark" onClick={() => routeChange(events.event1)} block >Sign Up</Button>
                        </Card.Body>
                    </Card>
                    <Card style={{ position: 'absolute', left: '17%', top: '61%', height: '18rem', width: '24rem' }}>
                        <Card.Body>
                            ...
                            <Button style={{ position: 'absolute', left: '0%', top: '87%' }} variant="dark" onClick={() => routeChange(events.event2)} block >Sign Up</Button>
                        </Card.Body>
                    </Card>
                    <Card style={{ position: 'absolute', left: '39%', top: '25%', height: '18rem', width: '24rem' }}>
                        <Card.Body>
                            ...
                            <Button style={{ position: 'absolute', left: '0', top: '87%' }} variant="dark" onClick={() => routeChange(events.event3)} block>Sign Up</Button>
                        </Card.Body>
                    </Card>
                    <Card style={{ position: 'absolute', left: '39%', top: '61%', height: '18rem', width: '24rem' }}>
                        <Card.Body>
                            ...
                            <Button style={{ position: 'absolute', left: '0', top: '87%' }} variant="dark" onClick={() => routeChange(events.event4)} block>Sign Up</Button>
                        </Card.Body>
                    </Card>
                    <Card style={{ position: 'absolute', left: '61%', top: '25%', height: '18rem', width: '24rem' }}>
                        <Card.Body>
                            ...
                            <Button style={{ position: 'absolute', left: '0', top: '87%' }} variant="dark" onClick={() => routeChange(events.event5)} block>Sign Up</Button>
                        </Card.Body>
                    </Card>
                    <Card style={{ position: 'absolute', left: '61%', top: '61%', height: '18rem', width: '24rem' }}>
                        <Card.Body>
                            ...
                            <Button style={{ position: 'absolute', left: '0', top: '87%' }} variant="dark" onClick={() => routeChange(events.event6)} block>Sign Up</Button>
                        </Card.Body>
                    </Card>
                </Container>
