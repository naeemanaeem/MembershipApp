                ...
                axios
                    ...
                    .then((res) => {
                        ...
                        if (totalHours < 15) {
                            ...
                            alert("You are not able to sign up for this volunteer oppurtunity as the maximum hours needed have been reached");
                            Promise.reject("You are not able to sign up for this volunteer oppurtunity");
                        }
    ...
    return (
        <Container>
            ...
            <Form noValidate validated={validated} onSubmit={handleSubmit} >
                ...
                <Button variant="dark" size='lg' type="submit" >Submit form</Button>
            </Form>
        </Container>
    );
}
