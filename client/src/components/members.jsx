...
import PaginationTable from "./membersTable/PaginationTable";
...
class Members extends Component {
    ...
    try {
      if (this.state.isAddNewMember) {
        ...
        const member = this.state.members.find(
          (m) => m._id === this.state.tempmember._id
        );
        if (member) {
  ...
  render() {
    return <PaginationTable members={this.state.members} />;
  }
  ...
  //         />
  //         <div>
  //           <Button onClick={this.handleAddNewMemberButtonClick}>
  //             Add Member
  //           </Button>
  //         </div>
  //         <PaginationTable />
